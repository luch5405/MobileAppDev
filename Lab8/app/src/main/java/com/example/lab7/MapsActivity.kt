...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private var daycareLngLar: String? = null
    var Lat: Double = 0.0
    var Lng: Double = 0.0
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        daycareLngLar = intent.getStringExtra("daycareLngLat")
        var LngLat = daycareLngLar!!.split(',')
        Lat = LngLat[0].toDouble()
        Lng = LngLat[0].toDouble()
